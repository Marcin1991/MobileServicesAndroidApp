...
import com.example.marcin.storyroom.MyRestClient;
...
public class DataProvider {
    ...
    public void createProduct(
        ...
        restClient.post("", params, new JsonHttpResponseHandler() {
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject response) {
                cannotCreate.apply(new Product(productName, lon, lat));
            }
    ...
    public void update(
        ...
        params.add("lon", String.valueOf(p.getLon()));
        params.add("lat", String.valueOf(p.getLat()));
        params.setUseJsonStreamer(true);
